        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"4rem", alignItems:"start" }}>
          ...
          >
            ...
            <h2 className="section-title" style={{ marginBottom:"1.6rem" }}>
              I break down threats,<br />
              <span>not just alerts</span>
            </h2>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:"1rem", maxWidth:520 }}>
              <p style={{ color:"rgba(240,255,244,0.65)", lineHeight:1.82, fontFamily:"'Rajdhani',sans-serif", fontSize:"1rem" }}>
                I&apos;m Rutvik Chavda — an Endpoint Security Engineer who spent 3+ years at Sophos handling some of the most complex
                escalations that enterprise customers throw at EDR/XDR platforms. My work lives in the gap between
                &quot;the alert fired&quot; and &quot;here&apos;s exactly what happened, why it happened, and how to stop it from happening again.&quot;
              </p>
              ...
              <p style={{ color:"rgba(240,255,244,0.55)", lineHeight:1.82, fontFamily:"'Rajdhani',sans-serif", fontSize:"1rem" }}>
                Outside casework I contribute to the global Sophos Staff Community, which earned me five recognition
                awards in CY25 including Top Contributor for the full year. I&apos;m actively seeking roles in
                Endpoint Security, Threat Detection, or Security Operations where I can bring this depth to a larger stage.
              </p>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                {["#ff5f56","#ffbd2e","#27c93f"].map((col, i) => (
                  <span key={i} style={{ width:10, height:10, borderRadius:"50%", background:col, opacity:0.8 }} />
                ))}
              ...
              <div style={{ padding:"1.4rem 1.2rem" }}>
                <p style={{ fontFamily:"'Share Tech Mono',monospace", fontSize:"0.72rem", color:"rgba(0,255,100,0.45)", marginBottom:"1rem", letterSpacing:"0.08em" }}>
                  $ ls -la skills/ | grep --color=always &quot;security&quot;
                </p>
