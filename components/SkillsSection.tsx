  ...
  return (
    <div style={{ marginBottom: "1rem" }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "0.35rem" }}>
        <span style={{ fontFamily: "'Rajdhani',sans-serif", fontSize: "0.88rem", color: "rgba(240,255,244,0.8)", fontWeight: 500 }}>
          {name}
        </span>
        <span style={{
      ...
      <div className="container">
        <div style={{
          ...
          <p className="section-copy">
            Every skill here is battle-tested across real enterprise escalations — ransomware incidents,
