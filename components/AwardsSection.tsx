...
const AWARDS = [
  ...
  },
  {
    ...
    icon: "◆",
    description:
      "Ranked as a top community staff contributor globally for the entire CY25 calendar year — recognised for the highest sustained volume of technically accurate, deeply detailed, and genuinely helpful support content across the Sophos partner and customer community.",
  },
  {
  ...
  },
  {
    ...
    icon: "◈",
    description:
      "Recognised as a top community staff contributor for Q3 CY25 — maintaining exceptional contribution quality and strong technical presence in the global Sophos community through the second half of the year.",
  },
  {
